    ...
    <section className="flex lg:flex-row flex-col lg:py-48 md:py-32 py-32 w-full h-full lg:pl-44 lg:pr-20 lg:px-0 md:px-20 px-10 lg:gap-12 md:gap-16 gap-20">
      <div className="flex flex-col lg:gap-12 md:gap-10 gap-10 lg:w-2/3 lg:text-[28px] md:text-[28px] text-lg text-gray-1">
        ...
        <ol className="list-decimal font-helvetica_light font-light lg:leading-[47.10px] md:leading-[41.21px] pl-10">
          <li>
            <p>
              Check your inbox for an email with the details of the webinar,
              including the date and time.
            </p>
          </li>
          <li>
            <p>
              Add the masterclass to your calendar to ensure you don't miss out
              on this valuable opportunity to boost your productivity and
              organization.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              Share this opportunity with your friends and colleagues who would
              benefit from this webinar. Let's help each other succeed!
            </p>
          </li>
        </ol>
        <p>
        ...
        <p className="lg:text-[22px] md:text-xl text-base font-bold lg:leading-9 md:leading-[29.44px] leading-normal">
          ...
          <Button className="bg-red-1 my-4 hover:bg-red-1/75 w-fit lg:h-28 md:h-[86px] h-[60px] px-8 py-3">
            <div className="flex flex-row gap-2 items-center">
              <Image
                ...
                alt="whatsapp"
              />
              <p className="text-white lg:text-[32px] md:text-2xl text-base font-helvetica">
