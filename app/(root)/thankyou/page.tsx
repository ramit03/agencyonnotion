  ...
  return (
    <section className="flex lg:flex-row flex-col lg:py-48 md:py-32 py-28 w-full h-full lg:pl-44 lg:pr-20 lg:px-0 md:px-20 px-10 lg:gap-12 md:gap-16 gap-20">
      <div className="flex flex-col lg:gap-12 md:gap-10 gap-10 lg:w-2/3 lg:text-[28px] md:text-[28px] text-lg text-gray-1">
        ...
        <p className="lg:text-[22px] md:text-xl text-base font-bold lg:leading-9 md:leading-[29.44px] leading-normal">P.S. If your plans change and you can't attend, kindly opt out through the link in your email. This small step ensures a seamless experience for all. We appreciate your understanding!</p>
