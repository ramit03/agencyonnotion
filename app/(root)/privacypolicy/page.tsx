...
function page() {
  return (
    <section className="flex flex-col md:mt-6 mt-16  w-full px-20 py-12 lg:gap-8  gap-4">
      ...
      <p className="subheader">We collect and store the following personal information:</p>
      <ul className="subheader list-disc ml-6">
      ...
      <p className="subheader">We use the information you provide for the following purposes:</p>
      <ul className="subheader list-disc ml-6">
      ...
      <p className="subheader">We will not share, sell, or distribute your personal information to third parties unless required by law.</p>
      
      <h2 className="header_2">Security</h2>
      <p className="subheader">We take reasonable steps to protect your personal information from unauthorized access or disclosure. However, please be aware that no method of transmission over the internet is entirely secure.</p>

      <h2 className="header_2">Your Choices</h2>
      <p className="subheader">If you wish to modify or remove your registration information, please contact us at <span className="cursor-pointer text-[#2964AA]"> team@redendron.com</span>.</p>

      <h2 className="header_2">Changes to this Policy</h2>
      <p className="subheader">We may update this Privacy Policy from time to time. Any changes will be posted on this page, and the date of the last update will be modified accordingly.</p>

      <h2 className="header_2">Contact Us</h2>
      <p className="subheader mb-20">If you have any questions or concerns about this Privacy Policy, please contact us at  <span className="cursor-pointer text-[#2964AA]"> team@redendron.com</span>.</p>
    </section>
  );
}
