...
function page() {
  return (
    <section className="flex flex-col md:mt-6 mt-16  w-full px-20 py-12 lg:gap-8  gap-4">
      ...
      Welcome to Agency on Notion! This Refund & Cancellation Policy outlines the terms and conditions regarding refunds and cancellations for our webinars.
      </p>
      <p className="subheader">
      By registering for our webinar, you agree to the terms of this policy.
      </p>
      <h2 className="header">Refunds</h2>

      <h2 className="header_2 my-0">Eligibility</h2>

      <ol className="subheader list-decimal ml-6">
        <li>Refunds will be provided only in cases where the webinar is canceled by Redendron Media.</li>
        <li>No refunds will be issued for participant-initiated cancellations.</li>
      </ol>

      <h2 className="header_2">Process</h2>
      <ol className="subheader list-decimal ml-6">
        <li>If a webinar is canceled by Agency on Notion, registered participants will be notified via email, and a full refund will be issued within 7 business days.</li>
      ...
      <ol className="subheader list-decimal ml-6">
        <li>Redendron Media reserves the right to cancel a webinar at any time due to unforeseen circumstances or insufficient registrations.</li>
