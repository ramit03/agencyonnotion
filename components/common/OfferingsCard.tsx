...
function OfferingsCard({ first, title, body, onclick }: OfferingType) {
  return (
    <section className="w-[42%] lg:w-[35%] hover:shadow-[0_20px_50px_rgba(129,_19,_14,_1)] duration-700 lg:h-fit flex flex-col  font-neue md:px-10 lg:px-14 py-20 border-[3px] border-red-1 rounded-3xl bg-black">
      <p className="uppercase self-start font-light text-sm text-[#F9F5F1]">
        {first}
      </p>
      <h4 className="text-white text-5xl lg:text-[55px] font-bold py-5">{title}</h4>
      <p className="text-base grow lg:text-lg text-[#F9F5F1] font-light py-5">
       {body}
      </p>
